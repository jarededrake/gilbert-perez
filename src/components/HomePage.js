    ...
    <div className='home-page'>
      ...
      <div className='main-info'>
        ...
        <div className='card-one-info'>
          <div data-aos='fade-right' className='card-one-picture'>
            <img
          ...
          <div data-aos='fade-left' className='card-one-text'>
            <h3>Hourly Rates</h3>
        ...
        <div className='card-two-info'>
          <div data-aos='fade-right' className='card-two-picture'>
            <img
          ...
          <div data-aos='fade-left' className='card-two-text'>
